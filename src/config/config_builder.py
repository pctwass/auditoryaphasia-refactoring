...
def build_configs():
    ...
    general_config_file_path = (
        os.path.join(repository_dir_base, "config", config_selector.conf_file_name)
        + ".json"
    )
    system_config_file_path = (
        os.path.join(
            repository_dir_base, "config", config_selector.conf_system_file_name
        )
        + ".json"
    )
    classifier_config_file_path = (
        os.path.join(
            repository_dir_base, "config", config_selector.conf_classifier_file_name
        )
        + ".json"
    )
...
def build_general_config(config_file_path: str):
    ...
    config.callibration_file_name_prefix = config_json_dict.get(
        "callibration_file_name_prefix"
    )
