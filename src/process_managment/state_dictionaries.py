...
def init_audio_state_dict(manager : multiprocessing.Manager):
...
def init_visual_fb_state_dict(manager : multiprocessing.Manager):
...
def init_acquisition_state_dict(manager : multiprocessing.Manager):
